...
public class TestKotlinRecyclerAdapter(val names : List<String>) : RecyclerView.Adapter<TestKotlinRecyclerAdapter.TestRecyclerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TestRecyclerViewHolder {
        ...
        return TestRecyclerViewHolder(v)
    }
    ...
    class TestRecyclerViewHolder(val item: View) : RecyclerView.ViewHolder(item) {
